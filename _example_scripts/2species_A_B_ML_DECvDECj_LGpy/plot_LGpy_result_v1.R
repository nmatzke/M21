...
# Setup
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/2species_A_B_ML_DECvDECj_LGpy/"
setwd(wd)
...
states_fn = "AB.results.txt"

# Remove this file, as it will append otherwise
splits_fn = "AB.results_splits00001.txt"
