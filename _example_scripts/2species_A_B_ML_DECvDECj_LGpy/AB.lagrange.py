...
notes = '''
cd /drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/2species_A_B_ML_DECvDECj_LGpy/

python AB.lagrange.py
...
while 1:
    if not i:
        outfname = "AB.results.txt"
    else:
        outfname = "AB.results-"+str(i)+".txt"
