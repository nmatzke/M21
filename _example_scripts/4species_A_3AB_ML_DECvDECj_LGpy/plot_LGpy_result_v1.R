...
# Setup
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/4species_A_3AB_ML_DECvDECj_LGpy/"
setwd(wd)
...
states_fn = "A_3AB.results.txt"

# Remove this file, as it will append otherwise
splits_fn = "A_3AB.results_splits00001.txt"
