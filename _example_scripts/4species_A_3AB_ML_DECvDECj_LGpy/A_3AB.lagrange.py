...
notes = '''
cd /drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/4species_A_3AB_ML_DECvDECj_LGpy/

python A_3AB.lagrange.py
...
{'area_adjacency': [[1, 1], [1, 1]],
 ...
 'newick_trees': [{'included': '__all__',
                   'name': 'Tree0',
                   'newick': '(sp4:3, (sp3:2, (sp2:1, sp1:1)N4:1)N5:1)N6;',
                   'root_age': 3.0}],
 'ranges': [(),
            (0,),
            (1,),
            (0, 1)],
 'taxa': ['sp1', 'sp2', 'sp3', 'sp4'],
 'taxon_range_data': {'sp1': (0,), 'sp2': (0,1), 'sp3': (0,1), 'sp4': (0,1)}}
### end data
"""
...
while 1:
    if not i:
        outfname = "A_3AB.results.txt"
    else:
        outfname = "A_3AB.results-"+str(i)+".txt"
