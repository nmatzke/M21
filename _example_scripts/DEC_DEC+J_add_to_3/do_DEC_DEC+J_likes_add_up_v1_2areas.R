...
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/DEC_DEC+J_add_to_3/write_areas/"
setwd(wd)

geogfn = "geog_2areas.data"
...
sum(exp(DEC_lnLs))
# 3
# (works -- 3 possible ancestral states, excluding null range)

# They don't add up to 4, because the probability of any possible tip data,
