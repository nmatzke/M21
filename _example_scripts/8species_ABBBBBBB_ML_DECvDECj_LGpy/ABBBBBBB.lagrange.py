...
notes = '''
cd /drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/8species_ABBBBBBB_ML_DECvDECj_LGpy/

python ABBBBBBB.lagrange.py
...
{'area_adjacency': [[1, 1], [1, 1]],
 ...
 'taxon_range_data': {'sp1': (0,), 'sp2': (1,), 'sp3': (1,), 'sp4': (1,), 'sp5': (1,), 'sp6': (1,), 'sp7': (1,), 'sp8': (1,)}}
### end data
"""
...
while 1:
    if not i:
        outfname = "ABBBBBBB.results.txt"
    else:
        outfname = "ABBBBBBB.results-"+str(i)+".txt"
