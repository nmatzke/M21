...
# Setup
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/7species_ABBBBBB_ML_DECvDECj_LGpy/"
setwd(wd)
...
states_fn = "ABBBBBB.results.txt"

# Remove this file, as it will append otherwise
splits_fn = "ABBBBBB.results_splits00001.txt"
