...
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/9species_8areas_ML_DECvDECj_BGB_2nested/"
setwd(wd)
...
#######################################################
# This is the example Newick file for Hawaiian 8areas
# (from Ree & Smith 2008)
# "trfn" = "tree file name"
...
# This is the example geography file for Hawaiian 8areas
# (from Ree & Smith 2008)
...
runslow = TRUE
resfn = "8areas_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
    {
...
resfn = "8areas_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
# PDF plots
#######################################################
pdffn = "8areas_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on 8areas M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on 8areas M0_unconstrained"
