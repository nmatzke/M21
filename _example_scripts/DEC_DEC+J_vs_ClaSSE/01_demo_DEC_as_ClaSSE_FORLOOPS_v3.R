...
# 
# 5a. (I double-checked that these produce the same likelihoods:
#    classe_params[param_names=="lambda111"] = birthRate
#    classe_params[param_names=="lambda111"] = 0
# 
# 6. An *exact* matching of likelihoods is not expected, 
#    because the numerical integration of likelihoods
#    along branches is an approximation. But, the correlation
#    should be high across a variety of different parameter
#    combinations, as is shown in the plot at the end.
#
# 7. The "data" here is a fake phylogeny (4 tips, arbitrarily
#    labeled humans, chimps, gorillas, orangs, with the shortest
#    branchlengths being 1, and with the tree being ultrametric)
#    and fake-ish dataset ("A" for humans-chimps-gorillas, 
#    representing Africa if you like, and "B" for orangs,
#    representing Asia if you like).  Note that these are not
#    the real divergence dates of these clades, and such a 
#    small tree (dataset size of n=4 species) is a bad dataset 
#    for inference of models with 2-3 parameters.  A small 
#    phylogeny is, however, useful for checking the consistency 
#    of calculations.
#######################################################
...
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/DEC_DEC+J_vs_ClaSSE/"
setwd(wd)
...
source("/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/DEC_DEC+J_vs_ClaSSE/ClaSSE_mods_v1.R")
...
write.table(results2, "DEC_v_ClaSSE_results_v1.txt", sep="\t", quote=FALSE)
