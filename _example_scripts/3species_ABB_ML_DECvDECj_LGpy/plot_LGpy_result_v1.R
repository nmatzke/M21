...
# Setup
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/3species_ABB_ML_DECvDECj_LGpy/"
setwd(wd)
...
states_fn = "ABB.results.txt"

# Remove this file, as it will append otherwise
splits_fn = "ABB.results_splits00001.txt"
