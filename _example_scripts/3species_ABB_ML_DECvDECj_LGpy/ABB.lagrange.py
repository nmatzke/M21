...
notes = '''
cd /drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/3species_ABB_ML_DECvDECj_LGpy/

python ABB.lagrange.py
...
{'area_adjacency': [[1, 1], [1, 1]],
 ...
 'ranges': [(),
            ...
            (0, 1)],
 'taxa': ['sp1', 'sp2', 'sp3'],
 'taxon_range_data': {'sp1': (0,), 'sp2': (1,), 'sp3': (1,)}}
### end data
"""
...
while 1:
    if not i:
        outfname = "ABB.results.txt"
    else:
        outfname = "ABB.results-"+str(i)+".txt"
