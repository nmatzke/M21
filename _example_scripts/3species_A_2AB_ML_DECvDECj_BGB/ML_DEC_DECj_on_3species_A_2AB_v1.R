...
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/3species_A_2AB_ML_DECvDECj_BGB/"
setwd(wd)
...
#######################################################
# This is the example Newick file for Hawaiian A_2AB
# (from Ree & Smith 2008)
# "trfn" = "tree file name"
trfn = "tree_3species.newick"
...
tr
plot(tr)
title("Example 3-species phylogeny, with branchlengths of 1")
...
# This is the example geography file for Hawaiian A_2AB
# (from Ree & Smith 2008)
geogfn = "geog_3species.data"
...
runslow = TRUE
resfn = "A_2AB_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
    {
...
resDEC$outputs@params_table["j","est"]
...
# [3,]    0 1.0000000 0.000000e+00 0.0000000
# [4,]    0 0.4784494 1.698697e-01 0.3516810
# [5,]    0 0.4256123 2.140516e-13 0.5743877
...
resfn = "A_2AB_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
# [3,]    0 1.0000000 0.00000000 0.0000000
# [4,]    0 0.4125452 0.23577865 0.3516762
# [5,]    0 0.3738563 0.05173551 0.5744082
...
# PDF plots
#######################################################
pdffn = "A_2AB_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on A_2AB M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on A_2AB M0_unconstrained"
...
# dis: 0.766216 ext: 1.85618e-08
# final -ln likelihood: 1.22503
# Ancestral splits for:	1
# 	A|A	0.425593	(2.0793)
# 	A_B|A	0.37415	(2.20813)
# 	B|A	0.200257	(2.83319)
# 
# Ancestral states for:	1
# 	A_B	0.574407	(1.77945)
# 	A	0.425593	(2.0793)
# 
# Ancestral splits for:	2
# 	A|A	0.478446	(1.96225)
# 	B|B	0.169878	(2.99771)
# 	A_B|A	0.101712	(3.51065)
# 	B|A	0.0797409	(3.75401)
# 
# Ancestral states for:	2
# 	A	0.478446	(1.96225)
# 	A_B	0.351677	(2.27008)
# 	B	0.169878	(2.99771)
# 
...
#          Current function value: 1.225033
#          Iterations: 3
