...
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/3species_ABB_ML_DECvDECj_BGB/"
setwd(wd)
...
#######################################################
# This is the example Newick file for Hawaiian ABB
# (from Ree & Smith 2008)
# "trfn" = "tree file name"
...
# This is the example geography file for Hawaiian ABB
# (from Ree & Smith 2008)
...
runslow = TRUE
resfn = "ABB_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
    {
...
resfn = "ABB_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
# PDF plots
#######################################################
pdffn = "ABB_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on ABB M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on ABB M0_unconstrained"
...
# dis: 0.0897149 ext: 7.07193e-08
# final -ln likelihood: 3.47196
...
# 	B|A_B	0.624743	(3.94238)
# 	B|B	0.321649	(4.60626)
# 
# Ancestral states for:	2
# 	A_B	0.678351	(3.86005)
# 	B	0.321649	(4.60626)
