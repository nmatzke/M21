...
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/8species_ABBBBBBB_ML_DECvDECj_BGB/"
setwd(wd)
...
runslow = TRUE
resfn = "ABBBBBBB_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
    {
...
resfn = "ABBBBBBB_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
# PDF plots
#######################################################
pdffn = "ABBBBBBB_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on ABBBBBBB M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on ABBBBBBB M0_unconstrained"
...
# dis: 0.0293467 ext: 1.69807e-06
# final -ln likelihood: 6.13769
...
# 	B|B	0.822742	(6.3328)
# 	B|A_B	0.172276	(7.89635)
# 
# Ancestral states for:	2
# 	B	0.822742	(6.3328)
# 	A_B	0.177258	(7.86784)
# 
# Ancestral splits for:	3
# 	B|B	0.968032	(6.17018)
# 
...
# (sp7:7.0,(sp6:6.0,(sp6:5.0,(sp5:4.0,(sp4:3.0,(sp3:2.0,(sp2:1.0,sp1:1.0)N8:1.0)N9:1.0)N10:1.0)N11:1.0)N12:1.0)N13:1.0)N14:0.0;
# 
# 
...
#          Current function value: 6.137646
#          Iterations: 3
