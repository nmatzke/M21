...
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/9species_ABBBBBBBB_ML_DECvDECj_BGB/"
setwd(wd)
...
#######################################################
# This is the example Newick file for Hawaiian ABBBBBBBB
# (from Ree & Smith 2008)
# "trfn" = "tree file name"
...
# This is the example geography file for Hawaiian ABBBBBBBB
# (from Ree & Smith 2008)
...
runslow = TRUE
resfn = "ABBBBBBBB_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
    {
...
resfn = "ABBBBBBBB_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
# PDF plots
#######################################################
pdffn = "ABBBBBBBB_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on ABBBBBBBB M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on ABBBBBBBB M0_unconstrained"
...
# dis: 0.0234219 ext: 7.77184e-07
# final -ln likelihood: 6.37269
# Ancestral splits for:	1
# 	B|A	0.999997	(6.37269)
# 
# Ancestral states for:	1
# 	A_B	0.999998	(6.37269)
# 
# Ancestral splits for:	2
# 	B|B	0.825296	(6.5647)
# 	B|A_B	0.170751	(8.14024)
# 
# Ancestral states for:	2
# 	B	0.825296	(6.5647)
# 	A_B	0.174704	(8.11735)
# 
...
#          Current function value: 6.372617
#          Iterations: 3
