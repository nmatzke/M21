...
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/7species_ABBBBBB_ML_DECvDECj_BGB/"
setwd(wd)
...
#######################################################
# This is the example Newick file for Hawaiian ABBBBBB
# (from Ree & Smith 2008)
# "trfn" = "tree file name"
...
# This is the example geography file for Hawaiian ABBBBBB
# (from Ree & Smith 2008)
...
runslow = TRUE
resfn = "ABBBBBB_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
    {
...
resfn = "ABBBBBB_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
# > resDECj$ML_marginal_prob_each_state_at_branch_top_AT_node
#       [,1]      [,2]         [,3]         [,4]
#  [1,]    0 0.0000000 1.000000e+00 0.0000000000
#  [2,]    0 0.0000000 1.000000e+00 0.0000000000
#  [3,]    0 0.0000000 1.000000e+00 0.0000000000
#  [4,]    0 0.0000000 1.000000e+00 0.0000000000
#  [5,]    0 0.0000000 1.000000e+00 0.0000000000
#  [6,]    0 0.0000000 1.000000e+00 0.0000000000
#  [7,]    0 1.0000000 0.000000e+00 0.0000000000
#  [8,]    0 0.4001095 4.001100e-01 0.1997805071
#  [9,]    0 0.9335890 4.445691e-07 0.0664105855
# [10,]    0 0.9780461 7.607075e-13 0.0219539247
# [11,]    0 0.9928650 7.409541e-14 0.0071350293
# [12,]    0 0.9978046 1.975864e-14 0.0021953948
# [13,]    0 0.9994512 4.939659e-15 0.0005488489


#######################################################
# PDF plots
#######################################################
pdffn = "ABBBBBB_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on ABBBBBB M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on ABBBBBB M0_unconstrained"
...
# dis: 0.0382874 ext: 4.97466e-07
# final -ln likelihood: 5.86716
# Ancestral splits for:	1
# 	B|A	0.999998	(5.86716)
# 
# Ancestral states for:	1
# 	A_B	0.999999	(5.86716)
# 
# Ancestral splits for:	2
# 	B|B	0.81726	(6.06896)
# 	B|A_B	0.176124	(7.60373)
# 
...
# (sp6:6.0,(sp6:5.0,(sp5:4.0,(sp4:3.0,(sp3:2.0,(sp2:1.0,sp1:1.0)N7:1.0)N8:1.0)N9:1.0)N10:1.0)N11:1.0)N12:0.0;
# 
# 
...
#          Current function value: 5.867150
#          Iterations: 3
