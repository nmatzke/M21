...
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/2species_A_B_ML_DECvDECj_BGB/"
setwd(wd)
...
#######################################################
# This is the example Newick file for Hawaiian A_B
# (from Ree & Smith 2008)
# "trfn" = "tree file name"
...
# This is the example geography file for Hawaiian A_B
# (from Ree & Smith 2008)
...
runslow = TRUE
resfn = "A_B_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
    {
...
resfn = "A_B_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
# dis: 1.13387e-06 ext: 0.000138878
# final -ln likelihood: 1.79176
# Ancestral splits for:	1
# 	A|B	0.999722	(1.79204)
# 
