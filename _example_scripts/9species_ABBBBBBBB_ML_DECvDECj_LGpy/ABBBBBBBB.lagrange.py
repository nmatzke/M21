...
notes = '''
cd /drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/9species_ABBBBBBBB_ML_DECvDECj_LGpy/

python ABBBBBBBB.lagrange.py
...
{'area_adjacency': [[1, 1], [1, 1]],
 ...
 'taxon_range_data': {'sp1': (0,), 'sp2': (1,), 'sp3': (1,), 'sp4': (1,), 'sp5': (1,), 'sp6': (1,), 'sp7': (1,), 'sp8': (1,), 'sp9': (1,)}}
### end data
"""
...
while 1:
    if not i:
        outfname = "ABBBBBBBB.results.txt"
    else:
        outfname = "ABBBBBBBB.results-"+str(i)+".txt"
