...
notes = '''
cd /drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/8species_A_7AB_ML_DECvDECj_LGpy/

python A_7AB.lagrange.py
...
{'area_adjacency': [[1, 1], [1, 1]],
 ...
 'newick_trees': [{'included': '__all__',
                   'name': 'Tree0',
                   'newick': '(sp8:7,(sp7:6,(sp6:5,(sp5:4,(sp4:3, (sp3:2, (sp2:1, sp1:1)N8:1)N9:1)N10:1)N11:1)N12:1)N13:1)N14;',
                   'root_age': 7.0}],
 'ranges': [(),
            (0,),
            (1,),
            (0, 1)],
 'taxa': ['sp1', 'sp2', 'sp3', 'sp4', 'sp5', 'sp6', 'sp7', 'sp8'],
 'taxon_range_data': {'sp1': (0,), 'sp2': (0,1), 'sp3': (0,1), 'sp4': (0,1), 'sp5': (0,1), 'sp6': (0,1), 'sp7': (0,1), 'sp8': (0,1)}}
### end data
"""
...
while 1:
    if not i:
        outfname = "A_7AB.results.txt"
    else:
        outfname = "A_7AB.results-"+str(i)+".txt"
