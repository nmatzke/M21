...
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/6species_A_5AB_ML_DECvDECj_BGB/"
setwd(wd)
...
#######################################################
# This is the example Newick file for Hawaiian A_5AB
# (from Ree & Smith 2008)
# "trfn" = "tree file name"
...
# This is the example geography file for Hawaiian A_5AB
# (from Ree & Smith 2008)
...
runslow = TRUE
resfn = "A_5AB_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
    {
...
#  [6,]    0 1.0000000 0.000000e+00 0.0000000
#  [7,]    0 0.3419815 3.234330e-01 0.3345855
#  [8,]    0 0.1921311 1.673646e-01 0.6405043
#  [9,]    0 0.1846539 1.304528e-01 0.6848933
# [10,]    0 0.2197659 8.661972e-02 0.6936144
# [11,]    0 0.3433235 2.124425e-13 0.6566765
...
resfn = "A_5AB_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
#  [6,]    0 1.0000000 0.00000000 0.0000000
#  [7,]    0 0.3331787 0.33223546 0.3345859
#  [8,]    0 0.1809011 0.17861586 0.6404830
#  [9,]    0 0.1621010 0.15302678 0.6848722
# [10,]    0 0.1734250 0.13298027 0.6935947
# [11,]    0 0.2662812 0.07706013 0.6566587
...
# PDF plots
#######################################################
pdffn = "A_5AB_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on A_5AB M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on A_5AB M0_unconstrained"
...
# dis: 0.896629 ext: 3.52236e-09
# final -ln likelihood: 1.31221
# Ancestral splits for:	1
# 	A_B|A	0.412444	(2.19787)
# 	A|A	0.343366	(2.38117)
# 	B|A	0.24419	(2.72202)
# 
# Ancestral states for:	1
# 	A_B	0.656634	(1.73284)
# 	A	0.343366	(2.38117)
# 
# Ancestral splits for:	2
# 	A|A	0.219807	(2.82722)
# 	A_B|A	0.189192	(2.97721)
# 	B|A	0.157707	(3.15923)
# 	B|A_B	0.104977	(3.56622)
# 	B|B	0.0866261	(3.75837)
# 	A_B|B	0.0745608	(3.90835)
# 	A|B	0.0621526	(4.09037)
# 
# Ancestral states for:	2
# 	A_B	0.693567	(1.67812)
# 	A	0.219807	(2.82722)
# 
# Ancestral splits for:	3
# 	A|A	0.18469	(3.00129)
# 	A_B|A	0.139196	(3.28408)
# 	B|B	0.130467	(3.34884)
# 	B|A	0.129746	(3.35439)
# 	B|A_B	0.112958	(3.49295)
# 	A_B|B	0.0983298	(3.63164)
# 	A|B	0.0916543	(3.70194)
# 
# Ancestral states for:	3
# 	A_B	0.684843	(1.69078)
# 	A	0.18469	(3.00129)
# 	B	0.130467	(3.34884)
# 
# Ancestral splits for:	4
# 	A|A	0.192163	(2.96162)
# 	B|B	0.167384	(3.09968)
# 	A_B|A	0.115769	(3.46837)
# 	B|A	0.112563	(3.49646)
# 	B|A_B	0.106616	(3.55073)
# 	A_B|B	0.100841	(3.60642)
# 	A|B	0.098048	(3.63451)
# 
# Ancestral states for:	4
# 	A_B	0.640453	(1.75779)
# 	A	0.192163	(2.96162)
# 	B	0.167384	(3.09968)
# 
# Ancestral splits for:	5
# 	A|A	0.341986	(2.3852)
# 	B|B	0.323428	(2.44099)
# 	A_B|A	0.0576489	(4.1656)
# 	B|A	0.0569976	(4.17696)
# 	B|A_B	0.0557573	(4.19896)
# 	A_B|B	0.0545206	(4.22139)
# 	A|B	0.0539046	(4.23275)
# 
# Ancestral states for:	5
# 	A	0.341986	(2.3852)
# 	A_B	0.334586	(2.40707)
# 	B	0.323428	(2.44099)
...
#          Current function value: 1.312212
#          Iterations: 3
