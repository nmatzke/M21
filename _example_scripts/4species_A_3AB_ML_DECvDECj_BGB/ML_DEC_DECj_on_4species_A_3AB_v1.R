...
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/4species_A_3AB_ML_DECvDECj_BGB/"
setwd(wd)
...
#######################################################
# This is the example Newick file for Hawaiian A_3AB
# (from Ree & Smith 2008)
# "trfn" = "tree file name"
...
# This is the example geography file for Hawaiian A_3AB
# (from Ree & Smith 2008)
...
runslow = FALSE
resfn = "A_3AB_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
    {
...
# [4,]    0 1.0000000 0.000000e+00 0.0000000
# [5,]    0 0.3904092 2.681718e-01 0.3414190
# [6,]    0 0.2656296 1.009172e-01 0.6334532
# [7,]    0 0.3634008 8.363826e-10 0.6365992
...
resfn = "A_3AB_DEC+J_M0_unconstrained_v1.Rdata"
runslow = FALSE
if (runslow)
    {
...
# [2,]    0 0.0000000 0.0000000 1.0000000
# [3,]    0 0.0000000 0.0000000 1.0000000
# [4,]    0 1.0000000 0.0000000 0.0000000
# [5,]    0 0.3319562 0.3266284 0.3414154
# [6,]    0 0.1934522 0.1730541 0.6334937
# [7,]    0 0.2456233 0.1177396 0.6366371
...
# PDF plots
#######################################################
pdffn = "A_3AB_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on A_3AB M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on A_3AB M0_unconstrained"
...
# dis: 0.849427 ext: 7.1275e-11
# final -ln likelihood: 1.28778
# Ancestral splits for:	1
# 	A_B|A	0.404894	(2.19191)
# 	A|A	0.363369	(2.30012)
# 	B|A	0.231737	(2.74993)
# 
# Ancestral states for:	1
# 	A_B	0.636631	(1.73935)
# 	A	0.363369	(2.30012)
# 
# Ancestral splits for:	2
# 	A|A	0.265599	(2.61355)
# 	A_B|A	0.176341	(3.02311)
# 	B|A	0.14409	(3.2251)
# 	B|B	0.100914	(3.58127)
# 	B|A_B	0.0956541	(3.6348)
# 	A_B|B	0.0670006	(3.99083)
# 	A|B	0.0547467	(4.19282)
# 
...
# 	A|A	0.390401	(2.22836)
# 	B|B	0.268183	(2.60386)
# 	A_B|A	0.0705879	(3.93868)
# 	B|A	0.0650668	(4.02012)
# 	B|A_B	0.0562871	(4.16507)
# 
# Ancestral states for:	3
# 	A	0.390401	(2.22836)
# 	A_B	0.341416	(2.36243)
# 	B	0.268183	(2.60386)
...
#          Current function value: 1.287780
#          Iterations: 3
