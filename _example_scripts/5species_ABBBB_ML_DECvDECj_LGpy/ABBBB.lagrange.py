...
notes = '''
cd /drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/5species_ABBBB_ML_DECvDECj_LGpy/

python ABBBB.lagrange.py
...
{'area_adjacency': [[1, 1], [1, 1]],
 ...
 'taxon_range_data': {'sp1': (0,), 'sp2': (1,), 'sp3': (1,), 'sp4': (1,), 'sp5': (1,)}}
### end data
"""
...
while 1:
    if not i:
        outfname = "ABBBB.results.txt"
    else:
        outfname = "ABBBB.results-"+str(i)+".txt"
