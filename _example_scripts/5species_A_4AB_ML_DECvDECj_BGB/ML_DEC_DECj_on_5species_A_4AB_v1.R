...
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/5species_A_4AB_ML_DECvDECj_BGB/"
setwd(wd)
...
#######################################################
# This is the example Newick file for Hawaiian A_4AB
# (from Ree & Smith 2008)
# "trfn" = "tree file name"
...
tr
plot(tr)
title("Example 5-species phylogeny, with branchlengths of 1")
...
# This is the example geography file for Hawaiian A_4AB
# (from Ree & Smith 2008)
...
runslow = TRUE
resfn = "A_4AB_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
    {
...
#  [5,]    0 1.0000000 0.000000e+00 0.0000000
#  [6,]    0 0.3554133 3.080550e-01 0.3365318
#  [7,]    0 0.2118630 1.484807e-01 0.6396563
#  [8,]    0 0.2275085 8.872476e-02 0.6837668
#  [9,]    0 0.3480898 2.109290e-13 0.6519102
...
resfn = "A_4AB_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
#  [5,]    0 1.0000000 0.00000000 0.0000000
#  [6,]    0 0.3384451 0.32502099 0.3365339
#  [7,]    0 0.1925112 0.16788605 0.6396028
#  [8,]    0 0.1950903 0.12119509 0.6837146
#  [9,]    0 0.3010665 0.04706981 0.6518637
...
# PDF plots
#######################################################
pdffn = "A_4AB_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on A_4AB M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on A_4AB M0_unconstrained"
...
# dis: 0.882699 ext: 1.80181e-08
# final -ln likelihood: 1.30597
# Ancestral splits for:	1
# 	A_B|A	0.410916	(2.19534)
# 	A|A	0.34815	(2.3611)
# 	B|A	0.240934	(2.72921)
# 
...
# 	A|A	0.227567	(2.78629)
# 	A_B|A	0.1876	(2.97942)
# 	B|A	0.155498	(3.16709)
# 	B|A_B	0.103409	(3.57504)
# 	B|B	0.0887336	(3.72809)
# 	A_B|B	0.0731498	(3.92122)
# 	A|B	0.0606325	(4.1089)
# 
...
# 	A|A	0.211914	(2.85755)
# 	B|B	0.148499	(3.21315)
# 	A_B|A	0.130635	(3.34132)
# 	B|A	0.121388	(3.41474)
# 	B|A_B	0.105479	(3.55522)
# 	A_B|B	0.0915429	(3.69692)
# 	A|B	0.0850629	(3.77034)
# 
# Ancestral states for:	3
# 	A_B	0.639587	(1.75291)
# 	A	0.211914	(2.85755)
# 	B	0.148499	(3.21315)
# 
# Ancestral splits for:	4
# 	A|A	0.355424	(2.34042)
# 	B|B	0.308041	(2.4835)
# 	A_B|A	0.0610242	(4.10246)
# 	B|A	0.0592373	(4.13218)
# 	B|A_B	0.0560219	(4.18799)
# 	A_B|B	0.0528889	(4.24554)
# 	A|B	0.0513402	(4.27526)
# 
# Ancestral states for:	4
# 	A	0.355424	(2.34042)
# 	A_B	0.336535	(2.39503)
# 	B	0.308041	(2.4835)
