...
notes = '''
cd /drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/7species_A_6AB_ML_DECvDECj_LGpy/

python A_6AB.lagrange.py
...
{'area_adjacency': [[1, 1], [1, 1]],
 ...
 'newick_trees': [{'included': '__all__',
                   'name': 'Tree0',
                   'newick': '(sp7:6,(sp6:5,(sp5:4,(sp4:3, (sp3:2, (sp2:1, sp1:1)N7:1)N8:1)N9:1)N10:1)N11:1)N12;',
                   'root_age': 6.0}],
 'ranges': [(),
            (0,),
            (1,),
            (0, 1)],
 'taxa': ['sp1', 'sp2', 'sp3', 'sp4', 'sp5', 'sp6', 'sp7'],
 'taxon_range_data': {'sp1': (0,), 'sp2': (0,1), 'sp3': (0,1), 'sp4': (0,1), 'sp5': (0,1), 'sp6': (0,1), 'sp7': (0,1)}}
### end data
"""
...
while 1:
    if not i:
        outfname = "A_6AB.results.txt"
    else:
        outfname = "A_6AB.results-"+str(i)+".txt"
