...
notes = '''
cd /drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/6species_A_5AB_ML_DECvDECj_LGpy/

python A_5AB.lagrange.py
...
{'area_adjacency': [[1, 1], [1, 1]],
 ...
 'taxon_range_data': {'sp1': (0,), 'sp2': (0,1), 'sp3': (0,1), 'sp4': (0,1), 'sp5': (0,1), 'sp6': (0,1)}}
### end data
"""
...
while 1:
    if not i:
        outfname = "A_5AB.results.txt"
    else:
        outfname = "A_5AB.results-"+str(i)+".txt"
