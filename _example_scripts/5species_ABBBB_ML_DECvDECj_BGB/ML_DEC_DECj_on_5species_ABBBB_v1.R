...
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/5species_ABBBB_ML_DECvDECj_BGB/"
setwd(wd)
...
#######################################################
# This is the example Newick file for Hawaiian ABBBB
# (from Ree & Smith 2008)
# "trfn" = "tree file name"
...
# This is the example geography file for Hawaiian ABBBB
# (from Ree & Smith 2008)
...
runslow = TRUE
resfn = "ABBBB_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
    {
...
resfn = "ABBBB_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
#  [5,]    0 1.0000000 0.000000e+00 0.000000000
#  [6,]    0 0.4009899 4.009903e-01 0.198019836
#  [7,]    0 0.9356431 4.455469e-07 0.064356481
#  [8,]    0 0.9801980 6.732719e-13 0.019802004
#  [9,]    0 0.9950495 4.455525e-14 0.004950503
...
# PDF plots
#######################################################
pdffn = "ABBBB_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on ABBBB M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on ABBBB M0_unconstrained"
...
# dis: 0.0728667 ext: 3.40081e-07
# final -ln likelihood: 5.11514
# Ancestral splits for:	1
# 	B|A	0.999999	(5.11514)
# 
# Ancestral states for:	1
# 	A_B	0.999999	(5.11514)
# 
# Ancestral splits for:	2
# 	B|B	0.756366	(5.39436)
# 	B|A_B	0.227636	(6.59514)
# 
# Ancestral states for:	2
# 	B	0.756366	(5.39436)
# 	A_B	0.243634	(6.52722)
# 
# Ancestral splits for:	3
# 	B|B	0.901484	(5.21885)
# 
# Ancestral states for:	3
# 	B	0.901484	(5.21885)
# 
# Ancestral splits for:	4
# 	B|B	0.929327	(5.18843)
# 
...
# (sp5:3.0,(sp4:2.25,(sp3:1.5,(sp2:0.75,sp1:0.75)N5:0.75)N6:0.75)N7:0.75)N8:0.0;
# 
# 
