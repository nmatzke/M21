...
# Setup
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/5species_A_4AB_ML_DECvDECj_LGpy/"
setwd(wd)
...
states_fn = "A_4AB.results.txt"

# Remove this file, as it will append otherwise
splits_fn = "A_4AB.results_splits00001.txt"
