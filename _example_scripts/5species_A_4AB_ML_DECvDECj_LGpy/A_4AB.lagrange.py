...
notes = '''
cd /drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/5species_A_4AB_ML_DECvDECj_LGpy/

python A_4AB.lagrange.py
...
{'area_adjacency': [[1, 1], [1, 1]],
 ...
 'newick_trees': [{'included': '__all__',
                   'name': 'Tree0',
                   'newick': '(sp5:4,(sp4:3, (sp3:2, (sp2:1, sp1:1)N5:1)N6:1)N7:1)N8;',
                   'root_age': 4.0}],
 'ranges': [(),
            (0,),
            (1,),
 ...
 'taxon_range_data': {'sp1': (0,), 'sp2': (0,1), 'sp3': (0,1), 'sp4': (0,1), 'sp5': (0,1)}}
### end data
"""
...
while 1:
    if not i:
        outfname = "A_4AB.results.txt"
    else:
        outfname = "A_4AB.results-"+str(i)+".txt"
