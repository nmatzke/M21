...
wd = "/drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/9species_ABalternate_ML_DECvDECj_BGB/"
setwd(wd)
...
#######################################################
# This is the example Newick file for Hawaiian ABalternate
# (from Ree & Smith 2008)
# "trfn" = "tree file name"
...
# This is the example geography file for Hawaiian ABalternate
# (from Ree & Smith 2008)
...
runslow = TRUE
resfn = "ABalternate_DEC_M0_unconstrained_v1.Rdata"
if (runslow)
    {
...
# > resDEC$ML_marginal_prob_each_state_at_branch_top_AT_node
#       [,1]         [,2]         [,3]      [,4]
#  [1,]    0 1.000000e+00 0.000000e+00 0.0000000
#  [2,]    0 0.000000e+00 1.000000e+00 0.0000000
#  [3,]    0 1.000000e+00 0.000000e+00 0.0000000
#  [4,]    0 0.000000e+00 1.000000e+00 0.0000000
#  [5,]    0 1.000000e+00 0.000000e+00 0.0000000
#  [6,]    0 0.000000e+00 1.000000e+00 0.0000000
#  [7,]    0 1.000000e+00 0.000000e+00 0.0000000
#  [8,]    0 0.000000e+00 1.000000e+00 0.0000000
#  [9,]    0 1.000000e+00 0.000000e+00 0.0000000
# [10,]    0 8.213175e-02 2.895607e-13 0.9178682
# [11,]    0 1.177831e-12 7.313756e-02 0.9268624
# [12,]    0 7.385450e-02 7.662233e-13 0.9261455
# [13,]    0 5.345439e-13 7.379418e-02 0.9262058
# [14,]    0 7.383904e-02 3.379999e-13 0.9261610
# [15,]    0 2.026459e-13 7.333276e-02 0.9266672
# [16,]    0 7.968201e-02 1.429985e-14 0.9203180
# [17,]    0 2.383843e-13 4.461665e-14 1.0000000
...
resfn = "ABalternate_DEC+J_M0_unconstrained_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
# PDF plots
#######################################################
pdffn = "ABalternate_DEC_vs_DEC+J_M0_unconstrained_v1.pdf"
pdf(pdffn, width=6, height=6)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS DEC on ABalternate M0_unconstrained"
...
#######################################################
analysis_titletxt ="BioGeoBEARS DEC+J on ABalternate M0_unconstrained"
