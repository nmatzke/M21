...
notes = '''
cd /drives/GDrive/__GDrive_projects/2018-01-02_Ree_Sanmartin/_example_scripts/4species_ABBB_ML_DECvDECj_LGpy/

python ABBB.lagrange.py
...
{'area_adjacency': [[1, 1], [1, 1]],
 ...
 'taxon_range_data': {'sp1': (0,), 'sp2': (1,), 'sp3': (1,), 'sp4': (1,)}}
### end data
"""
...
while 1:
    if not i:
        outfname = "ABBB.results.txt"
    else:
        outfname = "ABBB.results-"+str(i)+".txt"
